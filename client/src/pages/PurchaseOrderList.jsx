...
import { Plus, Search, Filter, ArrowLeft, FileText } from "lucide-react";
...
export default function PurchaseOrderList() {
  ...
  const filtered = orders.filter((o) => {
    ...
    const matchSearch =
      ...
      (o.vendorName || o.vendor?.name || "").toLowerCase().includes(search.toLowerCase());
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1">
            <h1 className="text-headline-md font-bold text-on-surface">Purchase Orders</h1>
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-12 text-center text-on-surface-variant">
                    <p className="font-semibold text-body-lg">No purchase orders found</p>
                    ...
                    >
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        {order.status === "CONFIRMED" && (
                          <button
                            onClick={() =>
                              navigate(`/vendor-bills/new?poId=${order.id}`)
                            }
